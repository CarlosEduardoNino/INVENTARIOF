<template>
  <q-page padding>
    <h2 class="text-center text-primary q-mb-lg">Movimientos de Entrada</h2>

    <q-btn
      color="primary"
      label="Nuevo Movimiento de Devolución de Salida"
      icon="add"
      class="q-mb-md"
      @click="openModal"
    />
    ...
    <q-dialog v-model="isModalOpen" persistent>
      <q-card class="q-pa-md q-card--bordered" style="max-width: 1000px; width: 90%; max-height: 90vh; overflow-y: auto;">
        <q-card-section class="bg-primary text-white text-center">
          <h2>{{ isEditing ? 'Editar' : isViewing ? 'Ver Detalles' : 'Nuevo' }} Movimiento de Devolución de Salida</h2>
        </q-card-section>
        <q-card-section>
